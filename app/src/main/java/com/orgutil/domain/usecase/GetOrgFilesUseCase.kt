...
class GetOrgFilesUseCase @Inject constructor(
    ...
    suspend operator fun invoke(uri: Uri? = null, query: String? = null, useDatabase: Boolean = false): Flow<List<OrgFileInfo>> {
        return repository.getOrgFiles(uri, query, useDatabase)
    }
}